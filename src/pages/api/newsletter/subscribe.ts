...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const siteUrl = import.meta.env.SITE_URL || import.meta.env.PUBLIC_SITE_URL || 'https://thelearningmachine.dev';
    ...
    if (!brevoResponse.ok) {
      ...
      const errorMessage = (brevoData?.message as string) || 'Failed to subscribe to newsletter';
